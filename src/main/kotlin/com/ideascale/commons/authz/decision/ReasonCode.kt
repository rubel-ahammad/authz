...
value class ReasonCode(val value: String) {
    ...
    companion object {
        ...
        val DENY_SUBSCRIPTION_INACTIVE = ReasonCode("DENY_SUBSCRIPTION_INACTIVE")
        val DENY_SUBSCRIPTION_SOFT_BLOCKED = ReasonCode("DENY_SUBSCRIPTION_SOFT_BLOCKED")
        val DENY_SUBSCRIPTION_READ_ONLY = ReasonCode("DENY_SUBSCRIPTION_READ_ONLY")
